...
class AxelaDesktop {
  ...
  createWindow() {
    this.mainWindow = new BrowserWindow({
      // Mobile app default size (portrait). Keep min sizes small and optionally lock resizing to emulate a mobile device.
      width: 390,
      height: 844,
      minWidth: 320,
      minHeight: 568,
      ...
      // Use a compact title bar style to mimic a mobile app chrome
